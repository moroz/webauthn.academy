...
`);if(!e)return;const o=l.querySelector("code.language-shell, code.language-plain")!==null,a=e.some(n=>n?.startsWith("$"));o&&a&&(e=e.filter(n=>n?.startsWith("$")).map(n=>n.replace("$ ","")).filter(Boolean)),navigator.clipboard.writeText(e.join(`
